...
/**
 * StarEffects - Handles all star-specific visual effects
 * Extracted from Body.js to reduce complexity and improve organization
 */
class StarEffects {
    /**
     * Add all star-specific visual effects to a body
